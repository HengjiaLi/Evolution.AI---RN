...
model_save_name1 = 'sim_noH.pth'
path1 = F"/content/drive/My Drive/Evolution.AI---RN/model_saved/{model_save_name1}"#Gdrive path
model_save_name2 = 'sim.pth'
path2 = F"/content/drive/My Drive/Evolution.AI---RN/model_saved/{model_save_name2}"#Gdrive path
...
def test(data):
    ...
    for batch_idx in range(len(data[0]) // bs):
        ...
        output_full = model_full.forward(input_img, input_qst)
        ...
        wrong_samples_full.append([wrong_img,wrong_qst,wrong_ans])
    return np.array(wrong_samples_noH),np.array(wrong_samples_full)
# TEST
...
print(len(Q8[0]))
print(bs)
wrong_samples_noH,wrong_samples_full = test(Q8)
name1 = 'wrong_samples_noH.npy'
name2 = 'wrong_samples_full.npy'
path1 = F"/content/drive/My Drive/Evolution.AI---RN/{name1}"#Gdrive path
path2 = F"/content/drive/My Drive/Evolution.AI---RN/{name2}"#Gdrive path
with open(path1, 'wb') as f:
    np.save(f, wrong_samples_noH)
    print('no H saved')
